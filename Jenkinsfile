     ...
     /*stage('SonarQube Analysis') {
          steps {
            // Analyzing code.
              ...
              stage('SonarQube analysis') {
                  steps{
                     withSonarQubeEnv(credentialsId: 'f5c44e4b9c7d15abdd971822a723dafb0ed4a3dc', installationName: 'Sonarqube-server-7.6') { // You can override the credential to be used
